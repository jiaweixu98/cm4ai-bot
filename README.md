...
- `/data/jiawei_data/cm4ai-bot/data`

Canonical pipeline build:

```bash
cd /data/jiawei_data/correct_pipline_code
...
- Cache location: `/data/jiawei_data/correct_bridge2aikg_full_web/intermediate/paper_embeddings_cache/`
...
- list snapshots under `/data/jiawei_data/correct_bridge2aikg_full_web/snapshots`
...
CACHE_DIR=/data/jiawei_data/cm4ai-bot/tmp/matrix_cache
LOCAL_DATA_DIR=/data/jiawei_data/cm4ai-bot/data
```
